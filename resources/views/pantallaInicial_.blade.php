...
<html lang="zxx">
<head>
	<title>Automatización de Modelo de Calidad para movilidad en Samrt City</title>
	<!-- for-mobile-apps -->
				...
				<div class="container">
					<nav class="navbar navbar-default">
						<div class="navbar-header">
							...
							<h1><a href="index.html">XXXX</a></h1>
						</div>
						<!--navbar-header-->
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav navbar-right">
								<li><a href="index.html" class="active">Inicio</a></li>
								<li><a href="{{ route('nuevaMedicion') }}">Nueva</a></li>
								<li><a href="{{ route('listadoMediciones') }}">Listado</a></li>
								<li><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Métricas <span class="caret"></span></a>
									<ul class="dropdown-menu">
										<li><a href="icons.html">Web Icons</a></li>
										<li><a href="codes.html">Short Codes</a></li>
									</ul>
								</li>
								<li><a href="contact.html">GOCAME</a></li>
							</ul>
						</div>
					</nav>
				</div>
							...
							<div class="flexslider">
								<ul class="slides">
									...
									<div class="w3_banner_info_grid">
										<h2>AUTOMATIZACIÓN Y APLICACIÓN</h2>
										<p style="font-size: 20px"><span class="label label-default"><b>de un Modelo de Calidad para flotas dinámicas en una Smart City</b></span></p>
										<ul>
											<li><a href="{{ route('nuevaMedicion') }}" class="w3ls_more" >Nuevo Proyecto de M&E</a></li>
											<li><a href="{{ route('listadoMediciones') }}" class="w3l_contact">Mediciones hechas</a></li>
										</ul>
									</div>
									</li>
									<!--<li>
			...
			<div class="inner_sec_grids_info_w3ls">
				...
				<div class="col-md-6 services-middle">
					<div class="services-middle-img">
						<img src="images/improve/g1.jpg" alt="" />
					</div>
...
<!-- bootstrap-pop-up -->
							...
							<div class="modal-content">
								...
								<section>
									<div class="modal-body">
										<img src="images/improve/g3.jpg" alt=" " class="img-responsive" />
	...
	<!-- js-scripts -->
	<!-- js -->
	<script type="text/javascript" src="js/improve/jquery-2.1.4.min.js"></script>
	<script type="text/javascript" src="js/improve/bootstrap.js"></script>
	<!-- Necessary-JavaScript-File-For-Bootstrap -->
	<!-- //js -->
	<!--Start-slider-script-->
	<script defer src="js/improve/jquery.flexslider.js"></script>
...
<!--End-slider-script-->
<script src="js/improve/responsiveslides.min.js"></script>
	...
	<!-- smooth scrolling -->
	<script type="text/javascript" src="js/improve/move-top.js"></script>
	<script type="text/javascript" src="js/improve/easing.js"></script>
...
<!-- //scrolling script -->
	...
	<!--search jQuery-->
	<script src="js/improve/main.js"></script>
	<!--//search jQuery-->
	<!-- stats -->
	<script src="js/improve/waypoints.min.js"></script>
	<script src="js/improve/counterup.min.js"></script>
	<script>
		jQuery(document).ready(function ($) {
			$('.counter').counterUp({
				delay: 100,
	...
	<!-- stats -->
	<!-- smooth scrolling -->
	<script src="js/improve/SmoothScroll.min.js"></script>
	<!-- //smooth scrolling -->
	<!-- js-scripts -->
</body>
